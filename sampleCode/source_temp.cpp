...
float PRateRoll = 0.8; // 0.6
float PRatePitch = PRateRoll;
float PRateYaw = 2;
float IRateRoll = 7.0; // 3.5
...
float PAngleRoll = 2; // 1.4
float PAnglePitch = PAngleRoll;
float IAngleRoll = 0; // 0.04
float IAnglePitch = IAngleRoll;
float DAngleRoll = 0; // 15
...
void loop()
{
    ...
    // }
    InputThrottle = ReceiverValue[2];
    DesiredAngleRoll = 0.10 * (ReceiverValue[0] - 1494.95);
    DesiredAnglePitch = 0.10 * (ReceiverValue[1] - 1499.95);
    ...
    // if (holdThrottleFlag)
    // {
    //     holdThrottleFlag = false;
    //     prevInputThrottle = InputThrottle;
    // }
    ...
    // if (isHoldThrottle() && ReceiverValue[4] > 1600)
    // {
    //     if (holdAltitudeFlag)
    //     {
    ...
    // if (ReceiverValue[2] > 1450 && ReceiverValue[2] < 1550 && ReceiverValue[4] > 1600)
